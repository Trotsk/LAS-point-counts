...
Requires Python 3.x
Requires LAStools downloaded into suggested data structure (C:\LAStools\bin)
"""
...
def main():
    ...
    for i in filename:
        # By default all output of lasinfo goes to stderr
        # A command argument redirects to stdout
        ...
        for key, val in f.items():
            if key in dict.keys():
                ...
                dict[key] = val  # unused key has key-value pair added to dict
